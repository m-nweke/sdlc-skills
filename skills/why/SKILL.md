...
Before spawning investigators, list the available MCPs from the system prompt (they appear in `<system-reminder>` blocks at the start of the session). Check which MCP servers are connected and what tools they expose.
